...
<div style="padding:20px 20px;">
	...
	<form action="home/" method="get">
		<p style="font-size:30px;font-weight: bold;text-align: center;"><i class="fa fa-sign-in"></i> ログイン</p>
		...
		<input type="submit" value="ログイン" style="margin-top:20px;font-size: 20px; width:100%;box-sizing: border-box;height:40px;line-height:40px;border:none;background:#ff9131;color:#fff;border-radius: 5px;cursor: pointer;">
	</form>
